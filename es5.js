...
module.exports = function (aClass, classes) {
  ...
  */
		if ("object" !== _typeof(this.constructors)) Object.defineProperty(this, 'constructors', {
			configurable: false,
			enumerable: false,
			writable: false,
			value: []
 ...
 */
	if (aClass.prototype && aClass.prototype !== null && aClass.prototype.__super__) (0, _mixin2.default)(superprototype, aClass.prototype.__super__);
	/*
 ...
 */
	for (var i = 0; i < cl; ++i) {
		if (classes[i].prototype) {
			if (classes[i].prototype.__super__) superprototype = (0, _mixin2.default)(superprototype, classes[i].prototype.__super__);
			superprototype = (0, _mixin2.default)(superprototype, classes[i].prototype);
		}
	}
 ...
 */
  ...
  */
		...
		if (!("object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && this === window || "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && this === global)) {
 ...
 */
	if (aClass.prototype) (0, _mixin2.default)(Mixin.prototype, aClass.prototype);
	/*
